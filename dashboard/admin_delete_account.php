...
// Confirm page (GET) or process deletion (POST)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_delete'])) {

    try {
        $pdo->beginTransaction();

        // 1. Get wedding_id and payment_slip for this user
    ...
    // Fetch couple info for confirmation page
...
<style>
    ...
    .btn-confirm-del:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(239,68,68,0.35); }
</style>
...
<div class="delete-confirm-card">
    ...
    <div class="delete-warning-list">
        ...
        <ul>
            ...
            <li><i class="fas fa-circle"></i> Entire photo gallery (files deleted)</li>
