...
.couple-title .amp { color: #8a9a7e !important; }
.date-chip { border: none !important; background: rgba(138,154,126,0.1); border-radius: 16px !important; padding: 16px 22px !important; }
.date-chip .val { color: #4a2c3b !important; }
.countdown-section { background: #4a2c3b !important; }
.countdown-section::before, .countdown-section::after { background: #8a9a7e !important; }
.time-value { color: #b7c3ac !important; }
.time-label { color: rgba(183,195,172,0.6) !important; }
.section-head .tag { color: #8a9a7e !important; }
.section-head h2 em { color: #4a2c3b !important; }
.letter-card { border-left: 5px solid #8a9a7e !important; border-radius: 0 16px 16px 0 !important; border-top: none !important; border-right: none !important; border-bottom: none !important; }
.letter-card::before { display: none; }
.tl-marker { background: #8a9a7e !important; border-radius: 50% !important; }
.tl-card { border-radius: 0 16px 16px 0 !important; border-left: 3px solid #8a9a7e !important; }
.btn-map { background: #4a2c3b !important; border-radius: 10px !important; }
.polaroid { border-radius: 16px !important; padding: 6px !important; background: linear-gradient(135deg, #fff, #f8f2e9) !important; }
.polaroid img { border-radius: 12px !important; }
.rsvp-card { border-radius: 0 30px 30px 0 !important; border-left: 5px solid #8a9a7e !important; }
.rsvp-aside { background: linear-gradient(160deg, #4a2c3b, #2e1a25) !important; }
.rsvp-option label { border-radius: 10px !important; }
.btn-rsvp-submit { background: #4a2c3b !important; border-radius: 10px !important; }
.inv-footer .brand { color: #4a2c3b !important; }
</style>
</head>
<body>
