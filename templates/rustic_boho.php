    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .letter-card {
            ...
            line-height: 1.9;
            color: var(--ink-mid);
            box-shadow: 0 14px 34px rgba(59,42,30,0.06);
        }
        .letter-card::before {
            content: '';
            position: absolute;
        ...
        .cal-menu {
            ...
            border: 1px solid var(--parchment-border);
            border-radius: 12px;
            box-shadow: 0 10px 30px rgba(59,42,30,0.12);
            min-width: 180px;
            z-index: 10;
            overflow: hidden;
        }
        ...
        .polaroid {
            ...
            box-shadow: 0 10px 22px rgba(59,42,30,0.12);
            cursor: pointer;
        ...
        .rsvp-card {
            ...
            box-shadow: 0 16px 44px rgba(59,42,30,0.08);
        }
        .rsvp-aside {
            background: linear-gradient(160deg, var(--plum-dark), var(--sage-dark));
            color: var(--parchment);
...
<style>
/* rustic_boho unique overrides – Earthy Hand-drawn */
.hero { border-radius: 0 0 40px 40px; overflow: hidden; }
.hero-media { background: linear-gradient(160deg, #7a4225, #4a2815) !important; }
.wax-seal { background: transparent !important; border: 3px dashed rgba(217,155,111,0.6) !important; box-shadow: none !important; }
.hero-panel { background: #faf3e7 !important; }
.eyebrow { color: #d99b6f !important; font-style: italic; }
.couple-title .amp { color: #d99b6f !important; font-family: 'Great Vibes', cursive !important; }
.date-chip { border: 2px dashed rgba(217,155,111,0.4) !important; border-radius: 20px !important; background: rgba(217,155,111,0.05); }
.date-chip .val { color: #7a4225 !important; }
.countdown-section { background: #7a4225 !important; border-radius: 0; }
.countdown-section::before, .countdown-section::after { border: 2px dashed #d99b6f !important; background: #faf3e7 !important; }
.time-value { color: #e6bd97 !important; }
.section-head .tag { color: #d99b6f !important; font-style: italic; }
.section-head h2 em { color: #7a4225 !important; }
.letter-card { border-radius: 20px !important; border: 2px dashed rgba(217,155,111,0.3) !important; background: rgba(250,243,231,0.6) !important; }
.letter-card::before { background: linear-gradient(to right, #d99b6f, #7a4225) !important; height: 3px !important; border-radius: 20px 20px 0 0; }
.tl-marker { background: #d99b6f !important; border-radius: 50% !important; border: 3px dashed #7a4225 !important; }
.tl-card { border: 2px dashed rgba(217,155,111,0.3) !important; border-radius: 20px !important; }
.btn-map { background: #7a4225 !important; border-radius: 50px !important; }
.btn-cal { border: 2px dashed rgba(217,155,111,0.4) !important; border-radius: 50px !important; }
.polaroid { border-radius: 14px !important; background: #faf3e7 !important; border: 2px dashed rgba(217,155,111,0.25) !important; box-shadow: none !important; }
.polaroid img { border-radius: 10px !important; }
.rsvp-card { border-radius: 24px !important; border: 2px dashed rgba(217,155,111,0.3) !important; }
.rsvp-aside { background: linear-gradient(160deg, #7a4225, #4a2815) !important; border-radius: 24px 0 0 24px; }
.rsvp-option label { border: 2px dashed rgba(217,155,111,0.3) !important; border-radius: 16px !important; }
.btn-rsvp-submit { background: #7a4225 !important; border-radius: 50px !important; }
.inv-footer .brand { color: #7a4225 !important; font-family: 'Great Vibes', cursive !important; }
</style>
</head>
<body>
