...
.hero-header { background: linear-gradient(180deg, #3d1e14 0%, #5a2e1e 40%, var(--cream) 100%) !important; }
.hero-header::before { background: radial-gradient(ellipse 120% 80% at 50% 30%, rgba(193,99,61,0.15), transparent) !important; }
